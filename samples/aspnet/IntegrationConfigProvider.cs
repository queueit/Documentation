using QueueIt.Connector.AspNet.IntegrationConfig;
using System;
using System.IO;
using System.Net;
using System.Timers;
...
namespace QueueIt.Connector.AspNet.Sample.IntegrationConfigLoader
{
    /// <summary>
    ...
    //    public static CustomerIntegration GetIntegrationConfigFromFile(string customerId, string pathToLocalFile)
    //    {
    //        if (!_isInitialized)
    //        {
    //            _customerId = customerId;
    ...
    //            {
    //                JavaScriptSerializer deserializer = new JavaScriptSerializer();
    //                var deserialized = deserializer.Deserialize<CustomerIntegration>(File.ReadAllText(pathToLocalFile));
